...
namespace MultilevelInheritance
{
    ...
    public class StudentDetail:PersonalDetails,IMarkDetail
    {
        ...
        public StudentDetail(string studentId,string aid,string name,String fatherName,Gender gender,long mobileNumber,Department department):base(aid,name,fatherName,gender,mobileNumber)
        {
           StudentID=studentId;
            Department=department;
